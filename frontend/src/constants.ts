...
export const MOCK_SURVIVORS: Survivor[] = [
  ...
  },
  {
    ...
    age: 25,
    gender: "f",
    lastLocation: { id: "loc2", latitude: 40.7128, longitude: -74.006 },
    inventory: {
  ...
  },
  {
    ...
    age: 24,
    gender: "f",
    lastLocation: { id: "loc10", latitude: 40.7128, longitude: -74.006 },
    inventory: {
      [MOCK_POSSIBLE_ITEMS[1].id]: 2,
      [MOCK_POSSIBLE_ITEMS[3].id]: 1,
    },
  ...
  },
  {
    ...
    age: 27,
    gender: "f",
    lastLocation: { id: "loc18", latitude: 40.7128, longitude: -74.006 },
    inventory: {
      [MOCK_POSSIBLE_ITEMS[0].id]: 2,
      [MOCK_POSSIBLE_ITEMS[2].id]: 1,
    },
